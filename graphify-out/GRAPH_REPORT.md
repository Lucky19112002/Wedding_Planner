...
## Corpus Check
- 153 files · ~57,510 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 10 file(s) not represented in the graph (top: (none) 9, .css 1)

## Summary
- 954 nodes · 1420 edges · 89 communities (62 shown, 27 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 35 edges (avg confidence: 0.94)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `99eda2a0`
...
Cohesion: 0.15
Nodes (5): ref_components_dashboard, ref_components_ui_card, ref_store_dashboardstore, actions, SummaryCardProps
...
Cohesion: 0.05
Nodes (32): ref_components_ui_input, ref_components_ui_textarea, ref_hookform_resolvers_zod, react-hook-form, ref_utils_outfitworkflow, ref_utils_participantvalidation, ref_utils_shoppinglinks, vitest (+24 more)

### Community 52 - "AppLayout.tsx"
Cohesion: 0.17
Nodes (7): ref_components_ui_unauthorizedstate, ref_hooks_useauth, ref_hooks_useprofile, ref_hooks_useweddingcontext, ref_store_uistore, ref_utils_permissions, navItems

### Community 53 - "outfits/index.ts"
Cohesion: 0.09
Nodes (9): ref_components_outfits_outfitcard, ref_components_outfits_outfitimageplaceholder, ref_components_outfits_outfitstatusbadge, ref_components_outfits_shoppinglinkcard, ref_components_outfits_shoppinglinkform, ref_store_shoppinglinkstore, ref_utils_outfitformat, ArchiveOutfitDialogProps (+1 more)
...
Cohesion: 0.07
Nodes (26): DashboardData, DashboardEventProgress, DashboardOutfitAnalytics, DashboardParticipantInsight, DashboardSummary, DashboardTimelineEvent, Event, EventInput (+18 more)

### Community 57 - "ref_types_domain"
Cohesion: 0.08
Nodes (9): ref_components_events_eventstatusbadge, ref_components_participants_participantavatar, ref_components_participants_participantrolebadge, ref_types_domain, ref_utils_dashboardmetrics, ref_utils_eventformat, colorByStatus, EventHeaderProps (+1 more)
...
Cohesion: 0.06
Nodes (30): Added, Added, Added, Added, Added, Changed, Changed, Changed (+22 more)
...
Cohesion: 0.09
Nodes (12): ref_components_participants_addparticipantdialog, ref_components_participants_participantemptystate, ref_components_participants_participantlist, ref_components_participants_removeparticipantdialog, ref_components_ui_button, ref_components_ui_emptystate, ref_components_ui_modal, ref_store_participantstore (+4 more)
...
### Community 66 - "react"
Cohesion: 0.10
Nodes (18): ref_components_events, ref_components_outfits, ref_components_participants, ref_components_ui_errorstate, ref_components_ui_loader, ref_components_ui_select, ref_hooks_usepermission, react (+10 more)
...
Cohesion: 0.11
Nodes (8): ref_components_outfits_participantoutfitssection, ref_components_participants_participantcard, ref_components_ui_avatar, ref_components_ui_badge, badgeClass, ParticipantEmptyStateProps, ParticipantListProps, labels
...
- **Why does `react` connect `react` to `AppErrorBoundary.tsx`, `ref_utils_cx`, `package.json`, `ref_lib_supabase`, `main.tsx`, `authStore.ts`, `OutfitGallery.tsx`, `ref_components_ui_card`, `EventForm.tsx`, `outfits/index.ts`, `Slot.tsx`, `ref_components_ui_button`?**
